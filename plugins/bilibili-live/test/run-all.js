...
const FILES = ['frame.test.js', 'policy.test.js', 'official.test.js', 'events.test.js', 'session.test.js', 'bridge.test.js', 'roominfo.test.js', 'settings.test.js', 'index.test.js'];
let failed = 0;
